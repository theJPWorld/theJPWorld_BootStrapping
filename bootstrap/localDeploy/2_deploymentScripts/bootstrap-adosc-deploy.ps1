...
./bootstrap/templates/scripts/bootstrap-ado.ps1 -Environment "dev" -TenantID "$TenantID" -AdoPAT "$AdoPATPlain"
...
# ./bootstrap/templates/scripts/bootstrap-ado.ps1 -Environment "tst" -TenantID "$TenantID" -AdoPAT "$AdoPATPlain"
...
# ./bootstrap/templates/scripts/bootstrap-ado.ps1 -Environment "sit" -TenantID "$TenantID" -AdoPAT "$AdoPATPlain"
...
# ./bootstrap/templates/scripts/bootstrap-ado.ps1 -Environment "uat" -TenantID "$TenantID" -AdoPAT "$AdoPATPlain"
...
# ./bootstrap/templates/scripts/bootstrap-ado.ps1 -Environment "prd" -TenantID "$TenantID" -AdoPAT "$AdoPATPlain"
